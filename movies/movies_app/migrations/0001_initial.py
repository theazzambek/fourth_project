    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fess_in_usa', models.PositiveIntegerField(default=0, help_text='Указывать сумму в долларах!', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=150, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Черновик')),
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies_app.actor', verbose_name='актёры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies_app.actor', verbose_name='режиссёр')),
                ('genres', models.ManyToManyField(to='movies_app.genres', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильмы',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies_app.movie', verbose_name='Фильмы')),
            ],
            options={
